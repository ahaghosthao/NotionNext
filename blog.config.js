...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '黑暗森林中的夜游者', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天马行空、重度拖延症、健身废材', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionstaticblog.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 黑暗森林中的夜游者', // 网站关键词 英文逗号隔开
